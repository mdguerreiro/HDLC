...
keytool -genkeypair -alias location_server_key_store -keyalg RSA -keysize 2048 -dname "CN=Baeldung" -validity 365 -storetype PKCS12 -keystore location_server_key_store.p12 -storepass location_server_pwd
...
keytool -exportcert -alias location_server_key_store -storetype PKCS12 -keystore location_server_key_store.p12 -file location_server_certificate.cer -rfc -storepass location_server_pwd
...
keytool -importcert -alias user1_key_store -storetype PKCS12 -keystore location_server_key_store.p12 -file user1_certificate.cer -rfc -storepass location_server_pwd -noprompt
keytool -importcert -alias user2_key_store -storetype PKCS12 -keystore location_server_key_store.p12 -file user2_certificate.cer -rfc -storepass location_server_pwd -noprompt
keytool -importcert -alias user3_key_store -storetype PKCS12 -keystore location_server_key_store.p12 -file user3_certificate.cer -rfc -storepass location_server_pwd -noprompt
keytool -importcert -alias user4_key_store -storetype PKCS12 -keystore location_server_key_store.p12 -file user4_certificate.cer -rfc -storepass location_server_pwd -noprompt
keytool -importcert -alias user5_key_store -storetype PKCS12 -keystore location_server_key_store.p12 -file user5_certificate.cer -rfc -storepass location_server_pwd -noprompt

# Import Public Keys of Users 2, 3, 4, 5 and Location Server From certificates into the Key Store of the User 1
keytool -importcert -alias location_server_key_store -storetype PKCS12 -keystore user1_key_store.p12 -file location_server_certificate.cer -rfc -storepass user1_pwd -noprompt
...
keytool -importcert -alias location_server_key_store -storetype PKCS12 -keystore user2_key_store.p12 -file location_server_certificate.cer -rfc -storepass user2_pwd -noprompt
...
keytool -importcert -alias location_server_key_store -storetype PKCS12 -keystore user3_key_store.p12 -file location_server_certificate.cer -rfc -storepass user3_pwd -noprompt
...
keytool -importcert -alias location_server_key_store -storetype PKCS12 -keystore user4_key_store.p12 -file location_server_certificate.cer -rfc -storepass user4_pwd -noprompt
...
keytool -importcert -alias location_server_key_store -storetype PKCS12 -keystore user5_key_store.p12 -file location_server_certificate.cer -rfc -storepass user5_pwd -noprompt
